...
// import is needed to be a keyword for the C++ module Standards proposal
	...
	T_MM_EXPOSED   = TOKEN_FROM_ID(422, KeywordTokenType),
	T_MM_IGNORE_START = TOKEN_FROM_ID(423, KeywordTokenType),
	T_MM_IGNORE_END = TOKEN_FROM_ID(424, KeywordTokenType),
	
	T_MM_EXPOSE = TOKEN_FROM_ID(425, KeywordTokenType),
